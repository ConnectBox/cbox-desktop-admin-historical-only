export const getOsisChTitle = (book,chapter) => {
  let retVal
  do {
    retVal = osisChTitles.eng[book][chapter]
    chapter--
  } while ((retVal==null) && (chapter>=1));
  return retVal
}

export const getChoiceTitle = (book,menuInx) => {
  let retVal
  if (osisChTitles.eng[book].choice!=null){
    retVal = osisChTitles.eng[book].choice[menuInx]
  }
  return retVal
}
  ...
  eng: {
    "Gen": {
      ...
      choice: {
        ...
        2: "Opposition and Rejection Builds",
        3: "Preparation of the Disciples",
        4: "Opposition and Rejection Climax",
        5: "Cross, Resurrection & Commission",
      },
      ...
      choice: {
        1: "Public Ministry",
        2: "Private Ministry, Arrest, Death & Resurrection"
      },
      ...
      choice: {
        1: "Jesus is Born, Early Ministry",
        2: "Doctrine, Miracles, Opposition",
        3: "Opposition Hardens, Death, Resurrection & Ascension",
      },
